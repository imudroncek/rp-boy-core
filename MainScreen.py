...
class MainScreen(Screen):
    ...
    def _get_footer(self):
        ...
        if (self.last_button_pressed != None):
            self.canvas.text(self.last_button_pressed, 0, self.height-7, 1)
    ...
    def _start_pressed(self):
        ...
        self.screens_helper.set_active_screen(
            self.main_menu.get_selected_item().get_new_screen_instance(self.width, self.height, self.display, self.canvas, self.button_input, self.screens_helper, self)
        )
